...
describe('Orders endpoints (e2e)', () => {
  ...
  beforeEach(async () => {
    const testingModuleBuilder = Test.createTestingModule({
      controllers: [MockOrdersController, MockAuthController]
    })
  ...
  it('GET /orders requires bearer token', async () => {
  ...
  it('GET /orders returns success envelope when logged in', async () => {
